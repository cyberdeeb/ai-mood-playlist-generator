...
function App() {
  ...
  const fetchPlaylists = async (mood) => {
    try {
      const response = await fetch(
        `https://ai-mood-playlist-generator-production.up.railway.app/playlist?mood=${mood}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        'https://ai-mood-playlist-generator-production.up.railway.app/detect-mood',
        {
          method: 'POST',
          headers: {
    ...
    <>
      ...
      <div className="card">
        <p className="description">
          Type how you feel and get a mood-matching playlist
        </p>
